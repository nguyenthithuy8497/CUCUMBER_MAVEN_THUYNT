...
public class HomePageObject extends AbstractPage {
	...
	public boolean isHomePageDisplayed(String welcomeMessage) {
		waitToElementVisible(driver, HomePageUI.HOMEPAGE_WELCOME_MESSAGE, welcomeMessage);
		boolean status= isControlDisplayed(driver, HomePageUI.HOMEPAGE_WELCOME_MESSAGE,welcomeMessage);
		return status;
	}
